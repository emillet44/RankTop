      ...
      <div className="min-h-[calc(100vh-64px)] bg-gradient-radial from-gray-950 to-stone-950 bg-fixed">
        <div className="flex justify-center pt-[124px] lg:pt-[76px] pb-10">
          <ul className="flex flex-row">
            <li>
              <header className="px-4 py-1.5 rounded-md text-xl font-medium text-gray-300 hover:text-white hover:bg-gray-700 transition-colors duration-200">My Groups</header>
            </li>
            <li>
              <header className="px-4 py-1.5 rounded-md text-xl font-medium text-white bg-gray-700">Create</header>
            </li>
            <li>
              <header className="px-4 py-1.5 rounded-md text-xl font-medium text-gray-300 hover:text-white hover:bg-gray-700 transition-colors duration-200">Search</header>
            </li>
          </ul>
        </div>
      </div>
