...
export function AddLike({ commentid, postid, userid }: { commentid: string, postid: string, userid: string | null }) {
...
function ChangeCommentLikes(commentid: string, arg1: boolean, arg2: string) {
