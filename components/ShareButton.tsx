  ...
  return (
    <div className="relative flex space-x-2">
      ...
      <button
        ...
        className="outline outline-2 outline-slate-700 rounded-md p-2 bg-slate-50 hover:bg-opacity-10 bg-opacity-5 text-slate-400 h-10 flex items-center space-x-2"
        ...
        <>
          ...
          {isShareOpen && (
            <div className="absolute right-0 top-12 z-50 bg-slate-800 border border-slate-700 rounded-md shadow-lg min-w-48 p-2">
              ...
              <a
                ...
                className="w-full flex items-center space-x-3 p-3 hover:bg-slate-700 rounded-md transition-colors"
                onClick={closeAllMenus}
              >
          ...
          {isExportOpen && (
            <div className="absolute right-0 top-12 z-50 bg-slate-800 border border-slate-700 rounded-md shadow-lg min-w-56 p-2">
              ...
              <button
                onClick={() => exportAsImage('square')}
                disabled={generatingFormats.has('square')}
                className="w-full flex items-center justify-between p-3 hover:bg-slate-700 rounded-md transition-colors disabled:opacity-50"
              >
              ...
              <button
                onClick={() => exportAsImage('twitter')}
                disabled={generatingFormats.has('twitter')}
                className="w-full flex items-center justify-between p-3 hover:bg-slate-700 rounded-md transition-colors disabled:opacity-50"
              >
                <div className="flex items-center space-x-3">
                  <FontAwesomeIcon icon={faImage} style={{ color: "#94a3b8" }} />
              ...
              <button
                onClick={() => exportAsImage('story')}
                disabled={generatingFormats.has('story')}
                className="w-full flex items-center justify-between p-3 hover:bg-slate-700 rounded-md transition-colors disabled:opacity-50"
              >
                <div className="flex items-center space-x-3">
                  <FontAwesomeIcon icon={faImage} style={{ color: "#94a3b8" }} />
