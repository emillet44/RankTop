      ...
      <div className="w-full px-4 md:px-6 flex items-center justify-between relative h-full">
        ...
        <div className="flex-1 flex items-center justify-end gap-x-2 md:gap-x-3">
          <div className="hidden md:flex items-center gap-x-2 md:gap-x-3">
            <Link 
              href="/groups" 
              className="h-8 flex items-center px-4 rounded text-[13px] font-bold text-slate-400 hover:text-offwhite hover:bg-white/5 border border-transparent transition-all capitalize tracking-normal"
            >
              Groups
            </Link>
            {signedin ? (
