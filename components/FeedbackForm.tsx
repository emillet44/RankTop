      ...
      {!submitted &&
        <form id="feedback" onSubmit={subHandler} className="flex justify-center pt-32 px-6">
          <div className="grid grid-cols-1 grid-flow-row auto-rows-auto gap-6 w-full max-w-2xl">
            ...
            <textarea name="report" className="rounded-xl outline focus:outline-4 outline-slate-700 max-h-96 h-52 p-5 text-slate-400 bg-slate-50 bg-opacity-5" required placeholder="Share your thoughts, suggestions, or report any issues with the site..."></textarea>
